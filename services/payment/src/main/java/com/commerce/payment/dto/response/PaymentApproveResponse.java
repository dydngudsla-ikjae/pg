...
public record PaymentApproveResponse(
        ...
        @Schema(description = "결제 상태", example = "PAID", allowableValues = {"PAID", "FAILED", "UNKNOWN"})
        String status,
        ...
        @Schema(description = "카드사 (승인 성공 시)", example = "신한")
        String cardCompany,

        @Schema(description = "카드 끝 4자리 (승인 성공 시)", example = "3456")
        String cardLast4,

        @Schema(description = "마스킹된 카드번호 (승인 성공 시)", example = "1234-56**-****-3456")
        ...
        @Schema(description = "결제 완료일시 (status=PAID 시)")
